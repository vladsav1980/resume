...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      educations: [
        {
          name: 'Dnipropetrovsk National University',
          isEnd: true,
        },
        {
          ...
          projects: [
            {
              ...
              about:
                'Aliqua incididunt mollit aliquip eiusmod elit officia ea exercitation labore nisi.',
              stackAmount: 3,
              stacks: [
                {
                  name: 'React.js',
              ...
              awards: [
                {
                  name: 'Non eiusmod tempor pariatur excepteur fugiat deserunt quis.',
                },
                {
                  name: 'In sint et anim ullamco velit ad qui nisi laboris laboris culpa.',
                },
              ],
            },
          ],
